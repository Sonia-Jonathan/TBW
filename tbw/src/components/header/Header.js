  ...
  return (
    <Navbar expanded={expanded} expand="lg" className={`header ${color ? 'header-bg' : ''}`}>
      <Container>
        ...
        >
          <Nav className=" col-10 col-lg-5 justify-content-lg-center m-lg-auto">
            <Nav.Link className="col-12 col-lg-2 neon-text-navbar text-white text-lg-center" href="/"><img className='col-2 col-md-1 col-lg-6' src={logo} /></Nav.Link>
